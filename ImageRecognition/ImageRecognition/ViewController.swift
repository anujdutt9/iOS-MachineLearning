...
class ViewController: UIViewController {
    ...
    let images = ["cat.jpeg", "dog.jpeg", "monkey.jpeg"]
    var imageIndex = 0
    ...
    @IBAction func nextImage(_ sender: Any) {
        ...
        self.imageLabel.text = "The model thinks that it is a \(prediction.classLabel) with a probability of \(prediction.classLabelProbs[prediction.classLabel] ?? 0)."
